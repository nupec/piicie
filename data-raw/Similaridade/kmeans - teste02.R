...
cidades <- unique(baseNNGeral$municipio) |> rep(18)
...
kFinal <- cbind(cidades, kGeral) |> as.data.frame()

# writexl::write_xlsx(kFinal, "data/similaridade/ttaNN.xlsx")
